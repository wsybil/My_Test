...
Suite *AriphmeticFunctions() {
  ...
  tcase_add_test(tc1_1, s21_mul_1000);
  ...
  tcase_add_test(tc1_3, s21_sub_1000);
  ...
  tcase_add_test(tc1_4, s21_div_2000);
  ...
  tcase_add_test(tc1_4, s21_div_1000);
...
Suite *CompareFunctions() {
  ...
  TCase *tc1_10 = tcase_create("s21_greater_or_equal");
...
Suite *AddFunctions() {
  Suite *s1 = suite_create("MODFunctions");
...
Suite *ChangeFunctions() {
  Suite *s1 = suite_create("ChangeFunctions");
  ...
  tcase_add_test(tc1_17, dec_to_float_37);
  tcase_add_test(tc1_17, dec_to_float_38);
  tcase_add_test(tc1_17, dec_to_float_39);
